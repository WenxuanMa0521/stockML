...
### Our Tree
    ...
    our_tree = new_tree.grow_tree(train_data, valid_data, var, y, split_dims = split_dims, leaf_dims = leaf_dims,  Nmin = Nmin, num_epochs = num_epochs, batch_size = batch_size, lr = lr, index = [1], region_info = 'All Data')
